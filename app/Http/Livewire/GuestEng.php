...
class GuestEng extends Component
{
    use WithPagination;
    public $group;
    public $name;
    ...
    public function submit()
    {
        ...
        Guests::create($data);
        return Redirect()->route('guest')->with('success','Data tamu sudah disimpan')->back()->withInput();
    ...
    public function render()
    {
        ...
        $guests=$this->guest;
        return view('livewire.guest-eng', compact('guests'));
    }
