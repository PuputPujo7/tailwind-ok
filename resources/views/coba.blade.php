...
<button type="button"
            ...
            <div>
                <button type="button"
                    class="p-1 bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
            ...
            <a href="/login"
                    class="p-1 px-3 flex items-center justify-between text-sm text-center text-gray-600 transition-colors duration-500 transform border rounded-lg lg:h-10 dark:text-gray-300 dark:border-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none bg-white">
                    Login
            </a>