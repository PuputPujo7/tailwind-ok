<div class="bg-blue-50 mx-auto py-6 px-4 w-full">
    <div class="px-4 py-6 gap-x-6 max-w-4xl mx-auto bg-blue-100 rounded shadow">
        <div class="mb-8 mt-2">
            <div class="mb-3 mt-3">
                <form wire:submit.prevent="submit" class="">
                    <div class="mt-3">    
                        <h2 class="text-center text-2xl font-bold text-blue-800 underline">Guest Book</h2>
                            <div class="mt-4">
                        ...
                        class="w-auto p-4 mt-4 text-center justify-center bg-blue-500 text-black py-2 rounded-md text-lg font-semibold">Submit</button> --}}
                            ...
                            <button type="submit"
                                class="w-auto p-4 mt-4 text-center justify-center bg-blue-500 text-black py-2 rounded-md text-lg font-semibold">Save
                                Contact</button>
                    </form>
                    @if (session('status'))
        ...
        <div class="bg-white rounded-lg shadow relative px-3 py-3 mt-5 mr-2">
                ...
                <table class="w-full">
                    <thead>
                        ...
                        <tr
                            ...
                            <th scope="col"
                                class="px-2 py-3 border-b w-10 sm:center text-center">No
                            </th>
                ...
                <table class="w-full">
                    <thead>
                        ...
                        <tr
                            ...
                            <th scope="col" class="px-4 py-3 border-b border-l border-r w-30 sm:center text-center text-gray-100">
                                Guest
                            </th>
                            <th scope="col" class="px-4 py-3 border-b border-l border-r w-30 sm:center text-center text-gray-100">
                                Agenda
