<div class="dropdown-menu sticky max-w-sm rounded top-16 right-0 mt-16">
    <div class="flag-app wawidget z-50 px-3 sticky max-w-sm rounded top-16 right-0 mt-16">
        <ul>
        ...
        <div class="mb-3 mt-3">
            <form wire:submit.prevent="submit" class="">
                <div class="mt-3">
                    ...
                    <div class="mt-4">
                        <p class="mb-1 text-gray-700 font-semibold text-sm">Kelompok (Perorangan/ Perusahaan - Instansi)
                        </p>
                    ...
                    <div class="grid gap-3 mb-3 sm:grid-cols-2 lg:grid-cols-2">
                        ...
                        <div>
                            <label for="phone"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">No. Telp./ HP
                            </label>
            ...
            <div id="myToast" class="fixed right-10 bottom-10 px-5 py-4 border-r-8mt-2 alert alert-success btn-success text-center justify-center bg-green-500 text-black py-2 px-2 rounded-md text-lg font-semibold">
                {{ session('success') }}
            </div>
                                ...
                                <h1 class="font-semibold">{{ $guest->name }}</h3>
                                    <div>
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <p class="text-lg items-center text-blue-500 underline">{{ $guest->email }}
                                            </p>
                                        </div>
