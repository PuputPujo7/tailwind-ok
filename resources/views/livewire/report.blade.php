<div class="bg-blue-50 mx-auto py-6 px-4 w-full">
    ...
    <h1 class="text-3xl py-4 border-b mb-10 bg-blue-100 rounded-lg text-center">Datatable</h1>
    <div class="overflow-x-auto bg-blue-100 rounded-lg shadow overflow-y-auto relative w-full px-3" style="height: 405px;">
            ...
            <div class="w-full overflow-x-auto">
              ...
              <th class="px-4 py-3">Date</th>
                        ...
                        <tr
                            ...
                            <th scope="col"
                                class="px-4 py-3 border-b border-l border-r w-1/6 sm:center text-center">Saldo Akhir</th>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-xs border">
                                <span
                                    class="px-2 py-1 font-semibold text-sm text-black-700">
                        ...
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-ms border font-bold">Rp. {{ number_format($reports->sum('entry')) }}</td>
                            <td class="px-4 py-3 text-ms border font-bold">Rp. {{ number_format($reports->sum('out')) }}</td>
                            <td class="px-4 py-3 text-ms border font-bold">Rp. {{ number_format($reports->sum('entry') - $reports->sum('out')) }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
