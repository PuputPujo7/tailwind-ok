            ...
            <div class="mb-3 mt-3">
                <form wire:submit.prevent="submit" class="">
                    <div class="mt-3">
                        ...
                        <div class="mt-4">
                            <p class="mb-1 text-gray-700 font-semibold text-sm">Guest Group (Personal/ Company -
                                Institution)
                            </p>
                        ...
                        <button type="button" @click="closeToast()" x-show="open" x-transition.duration.300ms class="fixed top-4 right-4 z-50 rounded-md bg-green-500 px-4 py-2 text-white transition hover:bg-green-600">
                            <div class="flex items-center space-x-2">
                              ...
                              <p class="font-bold">Data has been Saved</p>
                            </div>
                          </button>
                        
                          <!-- trigger button -->
                          <button type="submit" @click="openToast()" class="rounded-md bg-blue-500 px-4 py-2 font-bold text-white transition hover:bg-blue-600">Save</button>
                        {{-- </main> --}}
                ...
                @if (session('success'))
                    <div
                        class="mt-2 alert alert-success btn-success text-center justify-center bg-green-500 text-black py-2 px-2 rounded-md text-lg font-semibold">
                        {{ session('success') }}
                    </div>
                @endif
            </div>
